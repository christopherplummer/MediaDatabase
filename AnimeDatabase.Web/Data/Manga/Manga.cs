...
namespace AnimeDatabase.Web.Data.Manga
{
    ...
    {
        [JsonPropertyName("data")] public IEnumerable<Manga> Data { get; set; }

        [JsonPropertyName("data")] public ContainerMeta Meta { get; set; }

        [JsonPropertyName("data")] public ContainerLinks Links { get; set; }
