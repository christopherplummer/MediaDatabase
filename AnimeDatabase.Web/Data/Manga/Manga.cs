...
namespace AnimeDatabase.Web.Data.Manga
{
    ...
    public class Relationships
    {
        ...
        [JsonPropertyName("mangaProductions")]
        public RelationshipProperty MangaProductions { get; set; }

        [JsonPropertyName("mangaCharacters")]
        public RelationshipProperty MangaCharacters { get; set; }

        [JsonPropertyName("mangaStaff")]
        public RelationshipProperty MangaStaff { get; set; }
    }
}
